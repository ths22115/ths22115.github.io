...
export default function About() {
  return (
    ...
    <div className="text contact-text"> 
        ...
        <div className="subtext contact-subtext"><a className={"hyperlink"} target="_blank" href={"milesmckinleythomas@gmail.com"}>EMAIL<div className={"hyperlink-arrow"}>&#8599;</div></a></div>
