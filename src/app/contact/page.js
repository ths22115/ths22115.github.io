...
export default function Contact() {
  ...
  return (
    ...
    <div className="text contact-text">
        ...
        <div className="subtext contact-subtext"><a className={"hyperlink"} target="_blank" href={"https://www.linkedin.com/in/miles-thomas-552648245/"}>LINKEDIN<div className={"hyperlink-arrow"}>&#8599;&#xFE0E;</div></a></div>
