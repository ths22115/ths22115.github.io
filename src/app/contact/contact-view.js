...
export default function ContactView() {
  return (
    <div className="text contact-text">
        <div className="subtext contact-subtext"><a className={"hyperlink"} target="_blank" href={"mailto:milesmmthomas@gmail.com"}>EMAIL<div className={"hyperlink-arrow"}>&#8599;&#xFE0E;</div></a></div>
